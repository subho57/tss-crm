...
return [
    ...
    'accept_estimate_confirm' => "Please confirm that you want to accept this quote",
    'accept_estimate' => "Accept Quote",
    'accept' => "Accept",
    'accepted' => "Accepted",
    ...
    'action_only_available_on_declined_estimates' => "This request is only available on declined quotes",
    'action' => "Action",
    ...
    'add_estimate' => "Create A New Quote",
    'add_event' => "Add Event",
    ...
    'assigned' => "Assigned",
    'assigning_users_to_a_task_info' => "A job can only be assigned to users who are already assigned to the selected project.",
    'at' => "At",
    ...
    'decline_estimate_confirm' => "Please confirm that you want to decline this quote",
    'decline_estimate' => "Decline Quote",
    'decline' => "Decline",
    'declined' => "Declined",
    ...
    'default' => "Default",
    'delete_all_tasks' => "Delete all jobs",
    ...
    'estimate_aleady_published' => "This quote has already been published",
    'estimate_date' => "Quote Date",
    'estimate_has_expired_update_date' => "This quote has expired. Update the expiry date and try again",
    'estimate_not_found' => "Quote could not be found",
    'estimate_prefix' => "Quote Prefix",
    'estimate_still_draft' => "Quote is still in draft status",
    'estimate_template' => "Quote Template",
    'estimate_terms' => "Quote Terms & Conditions",
    'estimate' => "Quote",
    'estimated_hours' => "Quoted Hours",
    'estimates' => "Quotes",
    'event_accepted_estimate' => "Accepted a quote",
    ...
    'event_assigned_user_to_a_task_alt' => 'Assigned a job to',
    'event_assigned_user_to_a_task' => 'Assigned you to a job',
    ...
    'event_changed_task_status_completed' => "Completed a job",
    'event_changed_task_status' => "Changed job status",
    'event_changed_ticket_status' => "Changed support ticket status",
    'event_closed_ticket' => "Closed a support ticket",
    'event_created_estimate' => "Created an new quote",
    'event_created_invoice' => "Created a new invoice",
    'event_created_lead' => "Created a new job",
    'event_created_project' => "Created a new project",
    'event_created_subscription' => "Created a new subscription",
    'event_created_task' => "Created a new job",
    'event_declined_estimate' => "Declined an quote",
    ...
    'event_revised_estimate' => "Revised an quote",
    ...
    'expired' => "Expired",
    'expires' => "Expires",
    'expiry_date_must_be_after_estimate_date' => "Expiry date must be after quote date",
    ...
    'filter_estimates' => "Filter Quotes",
    ...
    'if_you_do_not_delete_tasks' => "If you do not delete jobs, they will be moved into (uncategoried) milestones",
    ...
    'logo_used_on_pdf_documents' => "Also used on invoices, quotes, etc.",
    ...
    'milestone_is_not_empty' => "Milestone has linked jobs. You must first move them",
    ...
    'move_down' => "Move Up",
    'move_tasks_to_another_milestone' => "Move jobs to another milestone",
    ...
    'publish_estimate' => "Publish Quote",
    'publish_invoice' => "Publish Invoice",
    'publish_proposal' => "Publish Proposal",
    'publish_revised_estimate' => "Publish Revised Quote",
    'publish' => "Publish",
    ...
    'show_archive_tasks' => "Show Archived Jobs",
    ...
    'show_task_after_adding' => "Show job after adding",
    'show_task' => "Show on job summary",
    'show' => "Show",
    ...
    'task_based_progress' => "Jobs Based Progress",
    'task_collaboration_info' => "Assigned users will be able to view and participate (comment, attach files, etc) in other users jobs",
    'task_collaboration' => "Job Collaboration",
    'task_id' => "Job ID",
    'task_not_found' => "Job could not be found",
    'task_participation' => "Jobs Participation",
    'task_priority' => "Job Priority",
    'task_settings' => "Job Settings",
    'task' => "Job",
    'tasks_collaboration' => "Jobs Colloboration",
    'tasks' => "Jobs",
    ...
    'template_lang_estimate_accepted' => "Quote Accepted",
    'template_lang_estimate_declined' => "Quote Declined",
    'template_lang_estimate_revised' => "Quote Revised",
    ...
    'template_lang_new_estimate' => "New Quote",
    ...
    'template_lang_task_assignment' => "Job Assignment",
    'template_lang_task_comment' => "Job Comment",
    'template_lang_task_file_uploaded' => "Job File Uploaded",
    'template_lang_task_status_change' => "Job Status Change",
    ...
    'text' => "Text",
    'thank_you' => "Thank You",
    'the_estimate_will_be_marked_as_revised' => "The quote will be marked as (Revised) and an email will be sent to the customer",
    'the_estimate_will_be_sent_to_customer' => "The quote will be emailed to the customer",
    ...
    'this_task_is_archived' => "This job is archived",
    'this_week' => "This Week",
    'this_year' => "This Year",
    ...
    'you_created_this_estimate' => "You created this quote",
    ...
    'you_created_this_task' => "You created this job",
    ...
    'start_timer' => "Start Timer",
    'no_tasks_found' => "No jobs found",
    'no_tasks_assigned_to_you' => "There are no jobs assigned to you on the selected project",
    'record_time' => "Record Time",
    'delete_original_estimate' => "Delete the original quote",
    'task_could_not_be_found' => "Job could not be found",
    'record_your_work_time' => "Record your work time",
    'record_time' => "Record Time",
    'mollie_general_info' => "Get this value from inside your Mollie dashboard",
    'you_are_now_not_assigned_to_this_task' => "You are not assigned to this job",
    ...
    'copy_estimate_terms' => "Copy quote terms",
    'copy_estimate_notes' => "Copy quote notes",
    'invoice_payment' => "Invoice Payment",
    ...
    'add_estimate_splah_title' => "Who is this quote for?",
    ...
    'copy_task_file' => "Copy Job Files",
    'copy_task_checklist' => "Copy Job Checklist",
    'additional_company_info' => "Addition company information to diplay on invoices and quotes",
    'templates' => "Templates",
    ...
    'this_is_total_logged_time_task' => "This is the total time you have loggged for this job. For individual time record, see your timesheets",
    ...
    'linked_to_tasks' => "Requires the jobs module",
    ...
    'statuses' => "Statuses",
    'add_new_task_status' => "Add New Job Status",
    'task_status_not_empty' => "This status is not empty. First move its jobs to another status",
    'delete_task_status' => "Delete Job Status",
